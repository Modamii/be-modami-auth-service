...
-- Required for Debezium CDC: capture full before-image on UPDATE/DELETE.
-- Without REPLICA IDENTITY FULL, WAL only contains the PK and `before` is NULL.
ALTER TABLE user_entity REPLICA IDENTITY FULL;
